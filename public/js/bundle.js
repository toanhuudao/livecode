...
exports.getAllCityOfCountry = exports.getNearestCity = exports.test = void 0;
...
var getNearestCity = /*#__PURE__*/function () {
  ...
  return function getNearestCity(_x, _x2) {
...
var getAllCityOfCountry = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(country) {
    var res;
  ...
  return function getAllCityOfCountry(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.getAllCityOfCountry = getAllCityOfCountry;
...
var findCountryNameBtn = document.querySelector("#findCountryNameBtn");
var outputListCity = document.querySelector("#outputListCity");
var prevButton = document.querySelector('#previousPage');
...
if (submitBtn) {
  submitBtn.addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var latitude, longitude, nearestCity, tag, text;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              event.preventDefault();
              _context.next = 5;
              return (0, _main.getNearestCity)(latitude, longitude);

            case 5:
              nearestCity = _context.sent;
              tag = document.createElement("p");
              text = document.createTextNode("nearestCity is ".concat(nearestCity.data.city));
...
if (findCountryNameBtn) {
  findCountryNameBtn.addEventListener("click", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      var countryName, listCity, current_page, records_per_page, changePage, numPages;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              event.preventDefault();
              countryName = document.querySelector("#countryName").value;
              _context2.next = 4;
              return (0, _main.getAllCityOfCountry)(countryName);

            case 4:
              listCity = _context2.sent;
              outputListCity.innerHTML = "";
              listCity.forEach(function (city) {
                var tag = document.createElement("p");
                var text = document.createTextNode(" ".concat(city.state));
                tag.appendChild(text);
              ...
              changePage = function changePage(page) {
                ...
                for (var i = (page - 1) * records_per_page; i < page * records_per_page && i < listCity.length; i++) {
